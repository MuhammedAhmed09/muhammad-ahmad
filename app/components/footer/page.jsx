...
const Footer = () => {
  ...
  return (
    <div className="lg:gap-20 gap-8 py-3 md:py-4 lg:py-5 text-white/70 flex flex-col lg:flex-row-reverse justify-center items-center w-full border-t border-Aqua-Neon/20">
